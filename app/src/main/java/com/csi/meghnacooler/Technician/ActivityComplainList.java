...
public class ActivityComplainList extends AppCompatActivity {
    ...
    String workshopName,workshopAddress,workshopPhone,workshopInfo,workshopAssignDate,workshopDeliveryDate;
                        ...
                        public void onClick(View view) {
                            ...
                            if ( buttonText.matches("close tickets")){
                                ...
                                buttonNotResolved.setOnClickListener(new View.OnClickListener() {
                                    @Override
                                    public void onClick(View view) {
                                        if (workshopFlag > 0 || solvedFlag > 0) {
                        ...
                        private void sendAction() {
                            ...
                            final StringRequest stringRequest = new StringRequest(Request.Method.PUT, URL, new Response.Listener<String>() {
                                ...
                                public void onResponse(String response) {
                                    ...
                                    try {
                                        Log.d("check_unsolved_1", "execute");
                                        JSONObject jsonObject = new JSONObject(response);
                                        Log.d("send_action_response: ", jsonObject.toString());
                                        complainList.clear();
                                        Log.d("check_unsolved_2", "execute");
                                        sendData();
                                        Log.d("check_unsolved_7", "execute");
                                        dialog.cancel();
                                    } catch (Exception e) {
