...
public class ReceivedRequisitionActivity extends AppCompatActivity {
    ...
    String inventoryLoadFromUrl, requisitionName;
    int inventoryIdLoadFromUrl;
            ...
            if (statusString.matches("complete")){
                ...
                view.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        textViewInventoryName.setText(inventoryLoadFromUrl);
                ...
                public void onClick(View view) {
                    ...
                    try {
                        if (quantityList.size() <= 0) {
                            Toast.makeText(ReceivedRequisitionActivity.this, "Please select the Chekbox", Toast.LENGTH_SHORT).show();
                        }
                        else {
                            ...
                            for (int i = 0; i < idList.size(); i++) {
                                ...
                                if (i+1 == idList.size()){
                                    jsonObjectFormData1.put("inventory_id", inventoryIdLoadFromUrl);
